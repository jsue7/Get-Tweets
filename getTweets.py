...
def search_recent_tweets(query_list):
    ...
    for query in query_list:
        ...
        for tweet in tweets.data:
            ...
            dataFrame.append([tweet_id, user_id, username, tweet_text, created_at, location, lang, source, reply_count, retweet_count,
                                like_count, quote_count, hashtags, urls, mentions, referenced_tweet_type, reference_reply_count, 
                                reference_retweet_count, reference_like_count, reference_quote_count, user_profile_url, tweet_url, 
                                reference_user_profile_url, reference_tweet_url])
...
query_list = ['Pascal Siakam', 'Fred VanVleet', 'Scottie Barnes', 'O.G. Anunoby', 'Gary Trent Jr.']
